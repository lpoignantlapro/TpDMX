...
namespace System
{
 ...
 #define _DECLARE_METACLASS(Base, Meta)                  \
  ...
  #if defined(_DELPHI_NEXTGEN) || defined(_PLAT_LINUX64) || defined(_PLAT_MACOS64)
    class RawByteString;
    class UTF8String;
...
#if (defined(_DELPHI_NEXTGEN) && !defined(_Windows)) || defined(_PLAT_LINUX64) || defined(_PLAT_MACOS64)
...
namespace System
{
  ...
  #elif !defined(_PLAT_LINUX64) && !defined(_PLAT_MACOS64)
